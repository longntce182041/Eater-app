...
const createProfileSchema = Joi.object({
    ...
    activityLevel: Joi.string()
        ...
        .required()
        .messages({
            "any.only": "Activity level must be one of: sedentary, light, moderate, active, very active",
            "any.required": "Activity level is required",
        }),
    healthGoals: Joi.string()
        .max(500)
        .default("")
        .messages({
    ...
    cookingSkillLevel: Joi.string()
        ...
        .default("beginner")
        .messages({
            "any.only": "Cooking skill level must be one of: beginner, intermediate, advanced",
        }),
    ...
    daily_calorie_target: Joi.number()
        .positive()
        .default(2000)
        .messages({
